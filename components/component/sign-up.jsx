...
import { auth } from "@/lib/firebase";  // Make sure this points to your firebase.js file
    ...
    <div className="min-h-screen w-full bg-background text-foreground">
      ...
      <main className="container mx-auto flex flex-col items-center justify-center gap-8 px-4 py-12 md:px-6 md:py-24">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Sign Up for AI'sle</h1>
